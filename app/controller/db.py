...
tables = {
'logininfo' :
u'''CREATE TABLE IF NOT EXISTS `%slogininfo` (
...
'userinfo' :
u'''CREATE TABLE IF NOT EXISTS `%suserinfo` (
	`id` int NOT NULL,
...
'discuss_topic' :
u'''CREATE TABLE IF NOT EXISTS `%sdiscuss_topic`(
	`id` int NOT NULL AUTO_INCREMENT,
...
'discuss_topic_cache':
u'''CREATE TABLE IF NOT EXISTS `%sdiscuss_topic_cache`(
	`id` int NOT NULL,
...
'discuss_reply' :
u'''CREATE TABLE IF NOT EXISTS `%sdiscuss_reply`(
	`id` int NOT NULL AUTO_INCREMENT,
...
'notice' :
u'''CREATE TABLE IF NOT EXISTS `%snotice`(
	`id` int NOT NULL AUTO_INCREMENT,
...
'notice_cache' :
u'''CREATE TABLE IF NOT EXISTS `%snotice_cache`(
	`id` int NOT NULL AUTO_INCREMENT,
	`data` TEXT NOT NULL,
	PRIMARY KEY (`id`)
)ENGINE=MyISAM DEFAULT CHARSET=utf8''',
'mail' :
u'''CREATE TABLE IF NOT EXISTS `%smail`(
	`id` int NOT NULL AUTO_INCREMENT,
	`from_uid` int NOT NULL,
	`to_uid` int NOT NULL,
...
'tag' :
u'''CREATE TABLE IF NOT EXISTS `%stag`(
	`id` int NOT NULL AUTO_INCREMENT,
